...
int Debug_AppendProgPos(char* str, struct prog_pos_info* prog_pos, const char* msg);
void Debug_Stripped5(void);
void Debug_PrintTrace(const char* msg, struct prog_pos_info* prog_pos);
void Debug_PrintDisplay(const char* fmt, ...);
...
enum monster_id Monster_FemaleToMaleForm(enum monster_id monster_id);
